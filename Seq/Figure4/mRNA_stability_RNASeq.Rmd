...
## Regression analysis of DS AS transcripts
...
## Cumulative fraction of DS AS transcripts
...
cdf <- ggplot(data=as.tr.fc.cdf, aes(x=logfc, group=AS_event, colour=AS_event)) +
  stat_ecdf() +
  ggtitle("Cumulative fraction of DS common HNRNPC-KD/UPF1-KD AS transcripts") +
  scale_color_manual(values = c(A3SS = "#7959b7", A5SS = "#00b7e6", general = "grey", MXE = "#ff955e", RI = "#f25a5f", SE = "#4487ab")) +
  theme_bw() +
